...
package com.machadocrypto.kobocoin_android_wallet.service;
...
import com.machadocrypto.kobocoinj.core.AbstractPeerEventListener;
import com.machadocrypto.kobocoinj.core.Address;
import com.machadocrypto.kobocoinj.core.Block;
import com.machadocrypto.kobocoinj.core.BlockChain;
import com.machadocrypto.kobocoinj.core.CheckpointManager;
import com.machadocrypto.kobocoinj.core.Peer;
import com.machadocrypto.kobocoinj.core.PeerEventListener;
import com.machadocrypto.kobocoinj.core.PeerGroup;
import com.machadocrypto.kobocoinj.core.Sha256Hash;
import com.machadocrypto.kobocoinj.core.StoredBlock;
...
import com.machadocrypto.kobocoinj.net.discovery.DnsDiscovery;
import com.machadocrypto.kobocoinj.net.discovery.PeerDiscovery;
import com.machadocrypto.kobocoinj.net.discovery.PeerDBDiscovery;
import com.machadocrypto.kobocoinj.net.discovery.PeerDiscoveryException;
import com.machadocrypto.kobocoinj.store.BlockStore;
import com.machadocrypto.kobocoinj.store.BlockStoreException;
import com.machadocrypto.kobocoinj.store.SPVBlockStore;
import com.machadocrypto.kobocoinj.store.ValidHashStore;
...
import com.machadocrypto.kobocoin_android_wallet.WalletBalanceWidgetProvider;
import com.machadocrypto.kobocoin_android_wallet.ui.WalletActivity;
import com.machadocrypto.kobocoin_android_wallet.util.CrashReporter;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private void notifyCoinsReceived(@Nullable final Address from, @Nonnull final BigInteger amount)
	{
		...
		final String tickerMsg = getString(R.string.notification_coins_received_msg,
				KOBOPrefix + ' ' + GenericUtils.formatValue(amount, KOBOPrecision, KOBOShift))
				+ msgSuffix;

		final String msg = getString(R.string.notification_coins_received_msg,
				KOBOPrefix + ' ' + GenericUtils.formatValue(notificationAccumulatedAmount, KOBOPrecision, KOBOShift))
				+ msgSuffix;
