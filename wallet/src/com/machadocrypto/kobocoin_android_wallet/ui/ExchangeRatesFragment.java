...
public final class ExchangeRatesFragment extends SherlockListFragment implements OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_EXCHANGE_CURRENCY.equals(key) || Configuration.PREFS_KEY_KOBO_PRECISION.equals(key))
		{
			defaultCurrency = config.getExchangeCurrencyCode();
	...
	private void updateView()
	{
		...
		if (adapter != null)
		{
			...
			final BigInteger base = KOBOShift == 0 ? GenericUtils.ONE_KOBO : GenericUtils.ONE_MKOBO;
	...
	{
		private BigInteger rateBase = GenericUtils.ONE_KOBO;
