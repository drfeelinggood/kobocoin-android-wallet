...
import com.machadocrypto.kobocoin_android_wallet.ui.RequestCoinsActivity;
import com.machadocrypto.kobocoin_android_wallet.ui.SendCoinsActivity;
import com.machadocrypto.kobocoin_android_wallet.ui.SendCoinsQrActivity;
...
public class WalletBalanceWidgetProvider extends AppWidgetProvider
{
			...
			@Nonnull final BigInteger balance)
	{
		...
		final Spannable balanceStr = new SpannableString(GenericUtils.formatValue(balance, config.getKOBOPrecision(), config.getKOBOShift()));
		...
		for (final int appWidgetId : appWidgetIds)
		{
			...
			views.setTextViewText(R.id.widget_wallet_prefix, config.getKOBOPrefix());
